...
router.get("/comercio", (req, res) => {
	const comercio = {
		...
		URL: "",
		imagenURL:
			"https://scontent.fmdq1-1.fna.fbcdn.net/v/t1.18169-9/14666270_1334353563242234_3263649987011451089_n.jpg?_nc_cat=102&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=PoUpuH2P-AkAX8jjEYB&_nc_ht=scontent.fmdq1-1.fna&oh=00_AfCDQZ-PrSPeo4QpY83Cn2qGnMMxNXVJWJDVmlwqGdW-Mg&oe=63965E90",
		productos: [],
		estrellas: 5,
		ratingPrecios: 3,
...
router.get("/comercios", (req, res) => {
	...
	const comercios = [comercio, comercio, comercio];
